...
<body class="bg-dark">
    <h1 class="text-light my-5 mx-auto col-2">ADELA LAUNDRY</h1>
            ...
            <form method="post">
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col-12 col-md-3 my-1">
                            <label>Status</label>
                            <select name="statuss" id="statuss" class="form-control" disabled>
                        ...
                        <div class="col-12 my-3">
                            ...
                            <p>NB: Beri Angka 0 jika data tidak bernilai.</p>
                        </div>
